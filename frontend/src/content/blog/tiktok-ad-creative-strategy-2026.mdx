...
<BlogComparison headers={["Ad Format", "Primary Use", "CPA vs In-Feed", "Best For"]} rows={[["Spark Ads", "Amplify proven organic content", "30-40% lower", "Creator partnerships, social proof building"], ["In-Feed Ads", "Direct response, product launches", "Baseline", "All e-commerce, creative testing at scale"], ["TikTok Shop Ads", "In-app purchase, impulse buys", "Lowest friction", "Products under $50, active TikTok Shop storefronts"], ["Video Shopping Ads", "Catalog-based retargeting", "Variable", "Large catalogs, supplementing UGC creative"]]} />
