...
<BlogComparison headers={["Time Horizon", "Action", "AI Tool Needed", "Expected Impact"]} rows={[["This Month", "Adopt an AI video generation tool", "CineRads or equivalent", "10x creative volume, 70% cost reduction"], ["This Month", "Build a persistent AI persona", "CineRads persona builder", "Brand consistency across all ads"], ["Next 6 Months", "Build segment-level creative", "Segment mixing tool", "Higher relevance, lower CPAs"], ["Next 6 Months", "Set up creative testing framework", "Ad platform + tracking", "Compounding creative learnings"], ["Next 12-24 Months", "Prepare for personalization at scale", "Dynamic creative tools", "Individual-level relevance"]]} />
