...
<BlogComparison headers={["Persona Type", "Audience", "Tone", "Content Style", "Use Case"]} rows={[["Primary Spokesperson", "Core customer segment", "Friendly, relatable", "UGC-style product reviews", "Most ads, all platforms"], ["Expert Voice", "Research-driven buyers", "Authoritative, educational", "Ingredient breakdowns, how-tos", "Mid-funnel, YouTube"], ["Deal Hunter", "Price-sensitive buyers", "Casual, value-focused", "Cost comparisons, promotions", "Retargeting, Meta Feed"], ["Community Voice", "Loyal customers", "Personal, enthusiastic", "Testimonials, user stories", "Social proof campaigns"]]} />
