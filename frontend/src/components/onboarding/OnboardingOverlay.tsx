...
function PersonaView({
  ...
  async function handleGenerateForExisting(persona: { id: string; name: string; attributes?: Record<string, unknown> | null }) {
    try {
          ...
          {personasWithoutImage.map((persona) => (
            ...
            >
              ...
              <Button
                ...
                onClick={() => handleGenerateForExisting(persona as { id: string; name: string; attributes?: Record<string, unknown> | null })}
