        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
          {
            ...
            value: [
              ...
              "media-src 'self' blob: https://*.supabase.co https://*.r2.dev https://commondatastorage.googleapis.com",
              "worker-src blob:",
              "connect-src 'self' blob: https://*.supabase.co https://*.supabase.in https://*.r2.dev https://api.stripe.com https://*.posthog.com https://*.sentry.io https://datafa.st https://unpkg.com https://*.clerk.accounts.dev https://clerk.cinerads.com https://accounts.cinerads.com https://api.clerk.dev https://clerk-telemetry.com",
