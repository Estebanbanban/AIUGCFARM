    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
          {
            ...
            value: [
              "default-src 'self'",
              `script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval'${isDev ? " 'unsafe-eval'" : ""} blob: https://js.stripe.com https://*.posthog.com https://*.sentry.io https://datafa.st https://*.clerk.accounts.dev https://clerk.cinerads.com`,
